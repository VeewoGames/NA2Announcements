...
![image](https://raw.githubusercontent.com/VeewoGames/NA2Announcements/master/announcements/EA_10.30/20251210_152125_6161410036019337262.png)
...
To thank all Agents who purchased the Supporter Pack, we’ve prepared new gifts! (Claim it in the Bar.)

**Agents with the Supporter Pack will receive additional variants for all past and future holiday cosmetics! No more worries about missing out on festival gifts!**

Thank you again for your support—more gifts are coming in the future. Stay tuned!

![image](https://raw.githubusercontent.com/VeewoGames/NA2Announcements/master/announcements/EA_10.30/20251210_152130_8755717194024896987.png)

# New Weapons

14 new weapons added, including 4 classics from the original game:

![image](https://raw.githubusercontent.com/VeewoGames/NA2Announcements/master/announcements/EA_10.30/20251210_152135_8300542141447429593.png)

* **JIMMY:** Fires fishbones that split into bone spikes.
* **FAMINE:** Fires homing piercing bullets.
* **SENTINEL:** Sacrifices some performance but gains a homing module.
...
* **QUAKE:** Fires both spark bullets and magic bullets—the latter release fireworks upon vanishing.
* **FISSURE:** Fires energy rocks that create shockwaves upon vanishing.
* **THUNDERBOLT:** Every few attacks, fires enhanced lightning arrows.
* **BONE SPIKE:** Rapidly fires consecutive spikes.
* **SPLASH:** Fires paintballs that deal area damage on hit.
* **JOYSPARK:** Fires bouncing magic bullets.
...
* **Thunder Drum:** Periodically summons lightning bolts during combat.
* **Butterfly Fan:** Periodically summons spirit butterflies that track enemies.
* **Divine Bamboo:** Periodically summons thunder swords to attack enemies.
* **Snowfox Brush:** Periodically fires talismans that trigger frost bursts on hit.
* **Restricted Document:** Periodically generates crystal spikes to attack enemies.
* **Night Vision Device:** Fires targeting beams that mark enemies, triggering explosions after a delay.
* **Volatile Coral:** Periodically generates bubbles that explode on contact.
* **Pisces Pendant:** Periodically fires Yin-Yang swords.
* **Cleopatra Scepter:** Periodically summons runic eyes to attack enemies.
* **Giant Belt:** Periodically throws a frost axe.
* **Weaver's Needle:** Periodically releases a needle that tracks and pierces enemies.
...
* **[New Curio] Drifting Bottle:** Consumes Crystals to store unopened Chests (max 5). Reuse to release all stored Chests.
...
* **Null Sample:** Melee attacks always erase enemy bullets (5s cooldown).
